...
public interface UserDAO {
    ...
    String SELECT_USERS = "SELECT USERS.OBJECT_ID AS USER_ID, LOGIN.VALUE AS LOGIN, USERS.NAME AS USER_NAME, " +
    ...
    String SELECT_USERS_BY_ROLE_AND_STATUS = "SELECT USERS.OBJECT_ID AS USER_ID, LOGIN.VALUE AS LOGIN, USERS.NAME AS USER_NAME, " +
            "            PHONENUMBER.VALUE AS PHONENUMBER, EMAIL.VALUE AS EMAIL, BIRTHDATE.DATE_VALUE AS BIRTHDATE, " +
