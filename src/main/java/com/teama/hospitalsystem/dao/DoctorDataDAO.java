...
public interface DoctorDataDAO {
    String UPDATE_DOCTORDATA_PROCEDURE = "UPDATE_DOCTOR_DATA";
    String CREATE_DOCTORDATA_FUNCTION = "CREATE_DOCTOR_DATA";

    String DOCTORDATA_ID = "DOCTORDATA_ID";
    String APPOINTMENT_DURATION = "APPOINTMENT_DURATION";

    String DOCTOR_DATA_PARENT_ID= "PARENT";
    String SPECIALIZATION_ID = "SPECIALIZATION";
